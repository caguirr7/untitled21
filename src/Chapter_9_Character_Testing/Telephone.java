...
public class Telephone {
    ...
    /**
     * The isFormatted method determines whether a string is properly formatted
     ...
     * (XXX) XXX-XXXX
     * If the argument is formatted in this way, the method
     * returns an unformatted string where the
    ...
    public static String unformat(String str){
        ...
        if(isFormatted(str)){
            ...
            previous deletions it is now located in
            position 6.
             */
            strb.deleteCharAt(6);
        }
